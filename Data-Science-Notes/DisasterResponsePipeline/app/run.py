...
def index():
    ...
    # Graph2 is a bar showing the distribution of Message Classes in our data
    graph2 = {
            'data': [
                pltgo.Bar(
                    x=classes,
    ...
    # Graph3 is a bar showing the distribution of average message lengths in our data
    graph3 = {
            'data': [
                pltgo.Bar(
                    x=classes,
